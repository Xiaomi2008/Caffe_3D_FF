if ispc
	...
	train_mat_pad_file ='z:\caffe_flx_kernel\data\snems3d_train_pad_2_47_47.mat';
else
	train_mat_file='/home/tzeng/caffe_flx_kernel/data/snems3d_train.mat';
	train_mat_pad_file ='/home/tzeng/caffe_flx_kernel/data/snems3d_train_pad_2_47_47.mat';
end
pad_h=2;
pad_w=47;
pad_d=47;
